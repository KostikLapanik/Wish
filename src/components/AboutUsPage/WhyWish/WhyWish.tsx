...
export function WhyWish() {
    function boxOnMouseDown(e: React.MouseEvent<HTMLElement>) {
        ...
        box.classList.add(styles.reasonPressed);
        box.classList.remove(styles.reasonReleased);
    }

    function boxOnMouseUp(e: React.MouseEvent<HTMLElement>) {
        const box = e.currentTarget;
        box.classList.remove(styles.reasonPressed);
        box.classList.add(styles.reasonReleased);
    ...
    return (
        <section className={styles.whyWish}>
            ...
            <div className={styles.container}>
                <div onMouseDown={boxOnMouseDown} onMouseUp={boxOnMouseUp} className={styles.reason}>
